...
import com.company.ACOPanel;
import com.company.AntColony;
import com.company.TSP;
import com.company.Tranformer;
...
/*--------------------------------------------------------------------*/
  ...
  {                             /* --- generate random pointgon */
    ...
    this.stat.setText("Problema aleatorio generado");
  ...
  {                             /* --- create "Generate..." dialog */
    ...
    lbl = new JLabel("Cantidad de puntos:");
    ...
    lbl = new JLabel("Semilla para numeros aleatorios:");
    g.setConstraints(lbl, lc);    grid.add(lbl);
    ...
    btn = new JButton("Aplicar"); bbar.add(btn);
    btn.addActionListener(new ActionListener () {
      public void actionPerformed (ActionEvent e) {
        ACODemo.this.genTSP(((Integer)vertcnt.getValue()).intValue(),
                            ((Integer)seed.getValue()).longValue());
      } } );
    btn = new JButton("Cerrar"); bbar.add(btn);
    btn.addActionListener(new ActionListener () {
      public void actionPerformed (ActionEvent e) {
        dlg.setVisible(false); } } );
  ...
  {                             /* --- create ant colony dialog */
    final JDialog      dlg  = new JDialog(this, "Crear colonia de hormigas...");
    GridBagLayout      g    = new GridBagLayout();
    GridBagConstraints lc   = new GridBagConstraints();
    GridBagConstraints rc   = new GridBagConstraints();
    JPanel             grid = new JPanel(g);
    ...
    lbl = new JLabel("Cantidad de Hormigas:");
    g.setConstraints(lbl, lc);     grid.add(lbl);
  ...
  {                             /* --- create run dialog */
    final JDialog      dlg  = new JDialog(this, "Correr Mejora...");
    GridBagLayout      g    = new GridBagLayout();
    GridBagConstraints lc   = new GridBagConstraints();
    GridBagConstraints rc   = new GridBagConstraints();
    JPanel             grid = new JPanel(g);
  ...
  {                             /* --- create GUI of ACO viewer */
    ...
    menu = mbar.add(new JMenu("Archivo"));
    menu.setMnemonic('f');
    item = menu.add(new JMenuItem("Cargar Viajante..."));
    item.setMnemonic('l');
    ...
    menu.addSeparator();
    item = menu.add(new JMenuItem("Salir"));
    item.setMnemonic('q');
    ...
    item = menu.add(new JMenuItem("Correr Mejora..."));
    item.setMnemonic('o');
    item.addActionListener(new ActionListener() {
      public void actionPerformed (ActionEvent e) {
        if (ACODemo.this.runopt == null)
    ...
    item = menu.add(new JMenuItem("Para mejoras"));
    item.setMnemonic('s');
    item.addActionListener(new ActionListener() {
      public void actionPerformed (ActionEvent e) {
    ...
    menu.addSeparator();
    item = menu.add(new JMenuItem("Redibujar"));
    item.setMnemonic('r');
    item.addActionListener(new ActionListener() {
      public void actionPerformed (ActionEvent e) {
        ACODemo.this.panel.repaint(); } } );

    /*menu = mbar.add(new JMenu("Ayuda"));
    menu.setMnemonic('h');
